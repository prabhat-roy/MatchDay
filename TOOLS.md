# TOOLS.md — every OSS tool registered for MatchDay

This file is the single inventory of every OSS tool wired up for MatchDay.
...
| domain-oss | [obs-ndi](domain-oss/obs-ndi/) | `domain-oss/obs-ndi/` (deployable) |
| domain-oss | [openligadb](domain-oss/openligadb/) | `domain-oss/openligadb/` (deployable) |
| domain-oss | [ovenmediaengine](domain-oss/ovenmediaengine/) | `domain-oss/ovenmediaengine/` (deployable) |
| domain-oss | [statsbomb-loaders](domain-oss/statsbomb-loaders/) | `domain-oss/statsbomb-loaders/` (doc-only) |
